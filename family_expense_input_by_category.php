...
<html>
<body>
<h3 align="center" style="font-family: Trebuchet MS">Expense Report</h3>
<form name="myForm" action="family_expense_details_category.php?expense_by=<?php echo $expense_by?>" onsubmit="return validateForm()" method="post" style="font-family: Trebuchet MS">
...
<tr>
<td>Expense</td>
<td><select name="expense" id="expense" class="form-control" required>
<option value="" selected disabled>-Select Expense-</option>
<?php 
$sql= "SELECT DISTINCT expense FROM family_expense_category ORDER BY expense";
