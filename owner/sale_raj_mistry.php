...
<label for="sale_raj_mistry_search" class="font-weight-bold lead text-dark"><font size="" color="red">Raj Mistry</font></label>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="sale_raj_mistry_search" id="sale_raj_mistry_search" class="form-control form-control-lg rounded-0 border-primary" placeholder="Search by Name or Address or Phone...">
...
&nbsp;&nbsp;&nbsp;&nbsp;<b>OR</b>&nbsp;&nbsp;&nbsp;&nbsp;
<td align ="right"><a href="sale_dues_print_by_type.php?type=<?='Raj Mistry'?>" class="btn btn-success">Print Dues</a></td>
</div>

<?php 
$stmt = $conn->prepare("SELECT * FROM customers WHERE type='Raj Mistry' ORDER BY name");
$stmt->execute();
...
<?php        
    // selecting rows
	$sql = "SELECT * FROM customers WHERE type='Raj Mistry' ";
    if( isset($_GET['char']) ){
...
$(document).ready(function(){
	$("#sale_raj_mistry_search").keyup(function(){
		var sale_raj_mistry_search = $(this).val();
		$.ajax({
		url: 'sale_raj_mistry_search.php',
		method: 'post',
		data: {query:sale_raj_mistry_search},
