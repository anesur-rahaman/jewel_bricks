...
<label for="distributor_search" class="font-weight-bold lead text-dark"><font size="" color="red">All Customer</font>&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;| Balance : <font size="" color="red"><?php echo number_format($total_dues);?></font>
</label>
</div>
