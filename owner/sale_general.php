...
<label for="sale_general_search" class="font-weight-bold lead text-dark"><font size="" color="blue">GENERAL</label></font>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="sale_general_search" id="sale_general_search" class="form-control form-control-lg rounded-0 border-primary" placeholder="Search by Name or Address or Phone...">
...
&nbsp;&nbsp;&nbsp;&nbsp;<b>OR</b>&nbsp;&nbsp;&nbsp;&nbsp;
<td align ="right"><a href="sale_dues_print_by_type.php?type=<?='General'?>" class="btn btn-success">Print Dues</a></td>
</div>
...
<?php        
    // selecting rows
	$sql = "SELECT * FROM customers where type='General' ";
    if( isset($_GET['char']) ){
...
$(document).ready(function(){
	$("#sale_general_search").keyup(function(){
		var sale_general_search = $(this).val();
		$.ajax({
		url: 'sale_general_search.php',
		method: 'post',
		data: {query:sale_general_search},
