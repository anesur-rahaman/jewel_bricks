...
?>
<td><a rel="facebox" href="vehicle_details_modify.php?id=<?=$row['id']?>" class="btn btn-warning btn-sm">Modify</a>
<a rel="facebox" href="vehicle_details_delete.php?id=<?=$row['id']?>" class="btn btn-danger btn-sm">Delete</a>
</td>
<?php
}
}
