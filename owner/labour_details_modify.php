...
<form name="myForm" action="labour_details_modify_action.php" method="post" style="font-family: Trebuchet MS">
<table width="500">
...
<td><input type="text" name="advance" id="advance" value="<?php echo $advance; ?>" class="form-control" placeholder="Enter Advance Amount"></td>
</tr>

<td>Wages Amount</td>
<td><input type="text" name="wages" id="wages" value="<?php echo $wages; ?>" class="form-control" placeholder="Enter Wages Amount"></td>
</tr>
