...
<label for="sale_supplier_search" class="font-weight-bold lead text-dark"><font size="" color="red">Supplier</font></label>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="sale_supplier_search" id="sale_supplier_search" class="form-control form-control-lg rounded-0 border-primary" placeholder="Search by Name or Address or Phone...">
...
&nbsp;&nbsp;&nbsp;&nbsp;<b>OR</b>&nbsp;&nbsp;&nbsp;&nbsp;
<td align ="right"><a href="sale_dues_print_by_type.php?type=<?='Supplier'?>" class="btn btn-success">Print Dues</a></td>
</div>

<?php 
$stmt = $conn->prepare("SELECT * FROM customers WHERE type='Supplier' ORDER BY name");
$stmt->execute();
...
$(document).ready(function(){
	$("#sale_supplier_search").keyup(function(){
		var sale_supplier_search = $(this).val();
		$.ajax({
		url: 'sale_supplier_search.php',
		method: 'post',
		data: {query:sale_supplier_search},
