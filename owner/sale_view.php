...
<?php
  ...
  if ($row['payment'] !="" ) {echo "<td>" . number_format(round($row['payment'], 2)) ."</td>";} else {echo "<td>";}
  if ($row['discount'] !="" ) {echo "<td>" . number_format(round($row['discount'], 2)) ."</td>";} else {echo "<td>";}?>
  ...
  //echo "<td><button><a href='sale_bill_delete.php?id=".$row['id']."&customer_id=".$row['customer_id']."'>Delete</a></button></td>";?>

<td>
<button><a href="sale_bill.php?id=<?=$row['id']?>&customer_id=<?=$row['customer_id']?>" <i class="far fa fa-address-card-o"></i>Challan</a></button>
<button><a rel='facebox' href="sale_bill_modify.php?id=<?=$row['id']?>&customer_id=<?=$row['customer_id']?>" <i class="far fa fa-address-card-o"></i>Modify</a></button>
<button><a rel='facebox' href="sale_bill_delete.php?id=<?=$row['id']?>&customer_id=<?=$row['customer_id']?>" <i class="far fa fa-address-card-o"></i><font size="" color="red">Delete</font></a></button>
</td>
