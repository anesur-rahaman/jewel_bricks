...
?>
<td>
<a rel='facebox' href="staff_details_modify.php?id=<?=$row['id']?>&staff_id=<?=$row['staff_id']?>" class="btn btn-warning btn-sm">Modify</a>
<a rel='facebox' href="staff_details_delete.php?id=<?=$row['id']?>&staff_id=<?=$row['staff_id']?>" class="btn btn-danger btn-sm">Delete</a>
</td>
<?php
  echo "</tr>";
}
