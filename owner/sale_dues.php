...
<label for="sale_dues_search" class="font-weight-bold lead text-dark">Search by Name or Address or Phone</label>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="sale_dues_search" id="search_text" class="form-control form-control-lg rounded-0 border-primary" placeholder="Search...">

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button><a href="sale_dues_print.php" <i class="far fa fa-address-card-o"></i><font size="" color="red"><b>Print</b></a></font></button></td>
