...
<?php
$id =$_REQUEST['id'];
$result = mysqli_query($conn, "SELECT * FROM labour WHERE id  = '$id'");
...
<html>
<body>
<h3 align="center" style="font-family: Trebuchet MS">Modify Labour Details</h3>
<form name="myForm" action="labour_modify_action.php" onsubmit="return validateForm()" method="post" style="font-family: Trebuchet MS">
<table width="300">
  <!--<tr>
...
<td><select name="type" id="type" value="<?php echo $type; ?>" class="form-control">
	...
	<option value="Coal Man">Coal Man</option>
	<option value="Fire Mistry">Fire Mistry</option>	
	<option value="Loader Mistry">Loader Mistry</option>	
	<option value="Rubbish Man">Rubbish Man</option>
	<option value="Trolley Wala">Trolley Wala</option>	
	<option value="Unload Man">Unload Man</option>
</select></td>
</tr>
