...
<form name="myForm" action="staff_wages_action.php" method="post" style="font-family: Trebuchet MS">
<table width="500">
...
<datalist id="months">
<?php
$stmt_details = mysqli_query($conn, "SELECT DISTINCT month FROM staff_details ORDER BY month");
...
<datalist id="years">
<?php
$stmt_details = mysqli_query($conn, "SELECT DISTINCT year FROM staff_details ORDER BY year");
while($row_details=mysqli_fetch_array($stmt_details)){
