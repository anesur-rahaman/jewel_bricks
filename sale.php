...
<label for="distributor_search" class="font-weight lead text-dark"><font size="" color="red"><?=$type?></font>&nbsp;&nbsp;
...
| Balance : <font size="" color="red"><?php echo number_format($running_balance);?></font></b>
</label>
</div>
