...
<div class="col-md-12 bg-light mt-2 rounded pb-3"><?php
	...
	<h4 align="center">Payment for <font size="" color="blue"><?php echo $name;?></font><small> (ID # <?php echo $customer_id;?>)</small>, <font size="" color="red"></font><font size="" color="dark green"><?php echo $address.'&nbsp;';?></font>|Total Due : <font size="" color="red"><?php echo number_format($due);?></font></h4>
<br>
<form method="post" action="sale_payment_action.php" id="myForm">
<div>
<table width="500">
...
<tr>
    ...
    <td><input type="number" name="payment" id="payment" class="form-control" min="0" oninput="validity.valid||(value='');" placeholder="Enter Payment Amount" required></td>
</tr>

<tr>
    <th><font size="" color="blue">Discount </font><br><font size="" color="blue"></font></th>
    <td><input type="number" name="discount" id="discount" class="form-control" min="0" oninput="validity.valid||(value='');" placeholder="Enter Discount Amount" required></td>
</tr>
