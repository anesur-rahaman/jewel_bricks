...
<form name="myForm" action="labour_advance_action.php" method="post" style="font-family: Trebuchet MS">
<table width="500">

<input type="hidden" name="labour_id" value="<?php echo $id; ?>" >

<td>Description</td>
	<td><input type="text" name="description" id="description" class="form-control" placeholder="Enter Description" required></td>
</tr>

<td>Advance Amount</td>
	<td><input type="number" name="advance" id="advance" class="form-control" placeholder="Enter Advance Amount" required></td>
</tr>
