...
<label for="distributor_search" class="font-weight lead text-dark"><font size="" color="red">All Customer</font>&nbsp;&nbsp;
<input type="text" name="distributor_search" id="search_text" class="form-control rounded border-primary" placeholder="Search by Name or Address or Phone...">
&nbsp;&nbsp;<b>OR
...
<td align ="right"><a href="sale_dues_print.php" class="btn btn-success btn-sm">Print Dues</a></td>
| Balance : <font size="" color="red"><?php echo number_format($total_dues);?></font></b>
</label>
</div>
