...
<form name="myForm" action="labour_salary_action.php" method="post" style="font-family: Trebuchet MS">
<table width="500">

<input type="hidden" name="labour_id" value="<?php echo $id; ?>" >

<tr>
<td>Monthly Salary</td>
	<td><input type="text" name="salary" id="salary" class="form-control" placeholder="Enter Monthly Salary" required></td>
</tr>
...
<tr>
<td>Salary Paid</td>
	<td><input type="text" name="wages" id="wages" class="form-control" placeholder="Enter Wages Amount" required></td>
</tr>

<tr>

<td>Month</td>
<td><input list="months" name="month" id="month" class="form-control" placeholder="Enter Month" required>
<datalist id="months">
<?php
$stmt_details = mysqli_query($conn, "SELECT DISTINCT month FROM labour_details ORDER BY month");
...
<tr>
<td>Year</td>
<td><input list="years" name="year" id="year" class="form-control" placeholder="Enter Year" required>
<datalist id="years">
<?php
$stmt_details = mysqli_query($conn, "SELECT DISTINCT year FROM labour_details ORDER BY year");
while($row_details=mysqli_fetch_array($stmt_details)){
