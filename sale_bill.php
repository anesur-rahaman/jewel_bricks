...
$result = mysqli_query($conn, "SELECT SUM(bill) as sum_bill, SUM(payment) as sum_payment, SUM(discount) as sum_discount FROM sale where id <'".$id."' AND customer_id ='".$customer_id."' ");
while($row = mysqli_fetch_array($result))
{
	$previous_dues = $row['sum_bill'] - $row['sum_payment'] - $row['sum_discount'];
}
?>
...
?>
<?php
$balancedue = $previous_dues + $bill - $payment_last
?>
...
<tr align="right">
    ...
    <td class="total-line"><div id="total"><?php echo number_format((float)$previous_dues);?></div></td>
</tr>
