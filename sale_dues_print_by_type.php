...
<?php        
	...
	$total_dues += $rowv['sum_bill'] - $rowv['sum_payment'] - $rowv['sum_discount'];
	}	
?>
...
&emsp;&emsp;
<label for="sale_dues_search" class="font-weight-bold lead text-dark"><?php echo $type;?> - Dues as of <?php echo date('d-M-Y H:i:a', strtotime($date));?> | Total  : ₹ 
